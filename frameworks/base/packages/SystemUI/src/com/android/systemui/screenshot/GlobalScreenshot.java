...
class GlobalScreenshot {
    ...
    private void takeScreenshot(Runnable finisher, boolean statusBarVisible, boolean navBarVisible,
        ...
        //mScreenBitmaps = new ArrayList<>();
        //mScreenBitmaps.add(mScreenBitmap);
        mScreenBitmap = addBitmap(mScreenBitmap, mScreenBitmap);
        final Context context = ActivityThread.currentApplication().getApplicationContext();
        android.util.Log.d("ccgD", "pkg = " + context.getPackageName());
    ...
    void takeScreenshotScroll(final Runnable finisher, final boolean statusBarVisible,
            final boolean navBarVisible) {
        mDisplay.getRealMetrics(mDisplayMetrics);
